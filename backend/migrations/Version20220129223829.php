 ...
 */
final class Version20220129223829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , level SMALLINT NOT NULL, level_name VARCHAR(50) NOT NULL, extra CLOB NOT NULL --(DC2Type:array)
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, organization, roles, enabled, confirmation_token FROM user');
        ...
        , enabled BOOLEAN NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, organization, roles, enabled, confirmation_token) SELECT id, username, password, name, email, organization, roles, enabled, confirmation_token FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, roles, organization, enabled, confirmation_token FROM user');
        $this->addSql('DROP TABLE user');
        ...
        , organization VARCHAR(255) DEFAULT NULL, enabled BOOLEAN NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, roles, organization, enabled, confirmation_token) SELECT id, username, password, name, email, roles, organization, enabled, confirmation_token FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}

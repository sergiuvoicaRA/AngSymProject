 ...
 */
final class Version20220109163233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partners (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, personal_info VARCHAR(255) NOT NULL, organization VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN role VARCHAR(255)');
        $this->addSql('ALTER TABLE user ADD COLUMN organization VARCHAR(255)');
    }

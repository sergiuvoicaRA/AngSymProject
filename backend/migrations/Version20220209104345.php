 ...
 */
final class Version20220209104345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , enabled BOOLEAN NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL COLLATE BINARY, is_partner BOOLEAN DEFAULT NULL)');

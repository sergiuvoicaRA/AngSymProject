 ...
 */
final class Version20220127163001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, organization, roles FROM user');
        ...
        , enabled BOOLEAN NOT NULL DEFAULT FALSE, confirmation_token VARCHAR(40) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, organization, roles) SELECT id, username, password, name, email, organization, roles FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, roles, organization FROM user');
        $this->addSql('DROP TABLE user');
        ...
        $this->addSql('INSERT INTO user (id, username, password, name, email, roles, organization) SELECT id, username, password, name, email, roles, organization FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}

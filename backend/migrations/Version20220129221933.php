 ...
 */
final class Version20220129221933 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        , organization VARCHAR(255) DEFAULT NULL, enabled BOOLEAN DEFAULT \'FALSE\' NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL)');
